...
type AxiosPromise<R> = R extends void ? Promise<any> : Promise<R>
...
export const ContainerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        containerAttachWebsocket(id: string, detachKeys?: string, logs?: boolean, stream?: boolean, stdin?: boolean, stdout?: boolean, stderr?: boolean, options?: any): AxiosPromise<void> {
            return localVarFp.containerAttachWebsocket(id, detachKeys, logs, stream, stdin, stdout, stderr, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns which files in a container\'s filesystem have been added, deleted, or modified. The `Kind` of modification can be one of:  - `0`: Modified (\"C\") - `1`: Added (\"A\") - `2`: Deleted (\"D\") 
         * @summary Get changes on a container’s filesystem
         ...
         * @throws {RequiredError}
         */
        containerChanges(id: string, options?: any): AxiosPromise<Array<FilesystemChange>> {
         ...
         * @throws {RequiredError}
         */
        containerRestart(id: string, signal?: string, t?: number, options?: any): AxiosPromise<void> {
            return localVarFp.containerRestart(id, signal, t, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Start a container
         ...
         * @throws {RequiredError}
         */
        containerStop(id: string, signal?: string, t?: number, options?: any): AxiosPromise<void> {
            return localVarFp.containerStop(id, signal, t, options).then((request) => request(axios, basePath));
        },
        /**
         * On Unix systems, this is done by running the `ps` command. This endpoint is not supported on Windows. 
         * @summary List processes running inside a container
...
export class ContainerApi extends BaseAPI {
     ...
     * @memberof ContainerApi
     */
    public containerAttachWebsocket(id: string, detachKeys?: string, logs?: boolean, stream?: boolean, stdin?: boolean, stdout?: boolean, stderr?: boolean, options?: RawAxiosRequestConfig) {
        return ContainerApiFp(this.configuration).containerAttachWebsocket(id, detachKeys, logs, stream, stdin, stdout, stderr, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContainerApi
     */
    public containerRestart(id: string, signal?: string, t?: number, options?: RawAxiosRequestConfig) {
        return ContainerApiFp(this.configuration).containerRestart(id, signal, t, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContainerApi
     */
    public containerStop(id: string, signal?: string, t?: number, options?: RawAxiosRequestConfig) {
        return ContainerApiFp(this.configuration).containerStop(id, signal, t, options).then((request) => request(this.axios, this.basePath));
    }
...
export const ImageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        imageList(all?: boolean, filters?: string, sharedSize?: boolean, digests?: boolean, options?: any): AxiosPromise<Array<ImageSummary>> {
            return localVarFp.imageList(all, filters, sharedSize, digests, options).then((request) => request(axios, basePath));
        },
        /**
         * Load a set of images and tags into a repository.  For details on the format, see the [export image endpoint](#operation/ImageGet). 
         * @summary Import images
...
export class ImageApi extends BaseAPI {
     ...
     * @memberof ImageApi
     */
    public imageList(all?: boolean, filters?: string, sharedSize?: boolean, digests?: boolean, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).imageList(all, filters, sharedSize, digests, options).then((request) => request(this.axios, this.basePath));
    }
...
export const NetworkApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        networkConnect(id: string, container: NetworkConnectRequest, options?: any): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        networkDisconnect(id: string, container: NetworkDisconnectRequest, options?: any): AxiosPromise<void> {
...
export class NetworkApi extends BaseAPI {
     ...
     * @memberof NetworkApi
     */
    public networkConnect(id: string, container: NetworkConnectRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof NetworkApi
     */
    public networkDisconnect(id: string, container: NetworkDisconnectRequest, options?: RawAxiosRequestConfig) {
...
export const SystemApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        systemDataUsage(type?: Array<SystemDataUsageTypeEnum>, options?: any): AxiosPromise<SystemDataUsageResponse> {
            return localVarFp.systemDataUsage(type, options).then((request) => request(axios, basePath));
        },
        /**
         * Stream real-time events from the server.  Various objects within Docker report events when something happens to them.  Containers report these events: `attach`, `commit`, `copy`, `create`, `destroy`, `detach`, `die`, `exec_create`, `exec_detach`, `exec_start`, `exec_die`, `export`, `health_status`, `kill`, `oom`, `pause`, `rename`, `resize`, `restart`, `start`, `stop`, `top`, `unpause`, `update`, and `prune`  Images report these events: `delete`, `import`, `load`, `pull`, `push`, `save`, `tag`, `untag`, and `prune`  Volumes report these events: `create`, `mount`, `unmount`, `destroy`, and `prune`  Networks report these events: `create`, `connect`, `disconnect`, `destroy`, `update`, `remove`, and `prune`  The Docker daemon reports these events: `reload`  Services report these events: `create`, `update`, and `remove`  Nodes report these events: `create`, `update`, and `remove`  Secrets report these events: `create`, `update`, and `remove`  Configs report these events: `create`, `update`, and `remove`  The Builder reports `prune` events 
         * @summary Monitor events
...
export class SystemApi extends BaseAPI {
     ...
     * @memberof SystemApi
     */
    public systemDataUsage(type?: Array<SystemDataUsageTypeEnum>, options?: RawAxiosRequestConfig) {
        return SystemApiFp(this.configuration).systemDataUsage(type, options).then((request) => request(this.axios, this.basePath));
    }
...
export const VolumeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        volumeUpdate(name: string, version: number, body?: VolumeUpdateRequest, options?: any): AxiosPromise<void> {
            return localVarFp.volumeUpdate(name, version, body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class VolumeApi extends BaseAPI {
     ...
     * @memberof VolumeApi
     */
    public volumeUpdate(name: string, version: number, body?: VolumeUpdateRequest, options?: RawAxiosRequestConfig) {
        return VolumeApiFp(this.configuration).volumeUpdate(name, version, body, options).then((request) => request(this.axios, this.basePath));
    }
}
